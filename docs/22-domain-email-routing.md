...
- Status: Public alias selected; owner destination and verification pending
...
3. Enable Email Routing for `firststepmontessori.com` and allow Cloudflare to add the required DNS records.
